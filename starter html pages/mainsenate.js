...
members.forEach(member => {
  ...
  if (member.party === 'I') {
    estadisticas.partys[2].members.push(member);
  }
});
...
estadisticas.partys[2]["%_voted_with-party"] = getVotedByPartyPCT(estadisticas.partys[2].members);

estadisticas.total_noofmembers = estadisticas.partys[0].members.length + estadisticas.partys[1].members.length + estadisticas.partys[2].members.length;
console.log(estadisticas.total_noofmembers);

estadisticas.total_pctvotedbyparty = ((parseInt(estadisticas.partys[0]["%_voted_with-party"]) + parseInt(estadisticas.partys[1]["%_voted_with-party"]) + parseInt(estadisticas.partys[2]["%_voted_with-party"])) / 3).toFixed(2);
